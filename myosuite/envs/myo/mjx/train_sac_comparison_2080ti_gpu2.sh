...
# RTX 2080 Ti GPU 2: 3 sequential runs; stop if a run fails.
...
python -u train_jax_sac.py --env_name=MjxHandPenTwirlRandom-v0 --impl=warp \
...
python -u train_jax_fastsac.py --env_name=MjxHandPenTwirlRandom-v0 --impl=warp \
  --num_envs=64 --num_timesteps=100000000 --seed=42 --batch_size=256 \
...
python -u train_jax_fastsac.py --env_name=MjxHandReachRandom-v0 --impl=warp \
  --num_envs=64 --num_timesteps=100000000 --seed=42 --batch_size=256 \
  --warp_graph_cache_size=1 --buffer_size=4096 --learning_starts=128 --num_updates=8 --policy_frequency=4 \
